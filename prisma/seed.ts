...
const problems = [
  ...
  },
  {
    ...
    difficulty: "easy",
    category: "javascript",
    description: `<p>You are climbing a staircase. It takes <code>n</code> steps to reach the top.</p><p>Each time you can either climb 1 or 2 steps. In how many distinct ways can you climb to the top?</p>`,
    examples: JSON.stringify([
  ...
  },
  {
    ...
    difficulty: "easy",
    category: "javascript",
    description: `<p>Given a non-empty array of integers <code>nums</code>, every element appears twice except for one. Find that single one.</p><p>Your solution must run in linear time and use only constant extra space.</p>`,
    examples: JSON.stringify([
  ...
  },
  {
    ...
    difficulty: "medium",
    category: "javascript",
    description: `<p>You are given an array <code>prices</code> where <code>prices[i]</code> is the price of a given stock on the <code>i</code>th day.</p><p>You want to maximize your profit by choosing a single day to buy one stock and choosing a different day in the future to sell that stock.</p><p>Return the maximum profit you can achieve, or <code>0</code> if no profit can be achieved.</p>`,
    examples: JSON.stringify([
    ...
    starterCode: `function main(prices) {\n  // Your code here\n}`,
  },
  {
  ...
  },
  {
    ...
    difficulty: "hard",
    category: "javascript",
    description: `<p>Given a string <code>s</code> and a dictionary of strings <code>wordDict</code>, return <code>true</code> if <code>s</code> can be segmented into a space-separated sequence of one or more dictionary words.</p><p>Note that the same dictionary word may be reused multiple times in the segmentation.</p>`,
    examples: JSON.stringify([
    ...
    starterCode: `function main(s, wordDict) {\n  // Your code here\n}`,
  },
  {
    ...
    examples: JSON.stringify([
      { input: "no input", output: "<select><option>Red</option><option>Blue</option></select>" },
    ]),
    testCases: JSON.stringify([
  ...
  },
  {
    ...
    difficulty: "medium",
    category: "html",
    description: `<p>Write raw HTML markup for a checkbox input and a radio button group.</p><p>The checkbox must have <code>type="checkbox"</code> and <code>name="subscribe"</code>. The radio buttons must have <code>type="radio"</code> and <code>name="color"</code>.</p>`,
    examples: JSON.stringify([
      { input: "no input", output: `<input type="checkbox" name="subscribe"><input type="radio" name="color"><input type="radio" name="color">` },
    ]),
    testCases: JSON.stringify([
  ...
  {
    title: "CSS Spinner Animation",
    slug: "css-spinner-animation",
    difficulty: "medium",
    category: "css",
    description: `<p>Write a raw CSS rule for class <code>.spinner</code> that applies a spin animation, plus the <code>@keyframes spin</code> block.</p><p>The CSS must include:</p><ul><li>Animation: <code>animation: spin 1s linear infinite</code></li><li>A <code>@keyframes spin</code> block</li><li>End rotation: <code>rotate(360deg)</code></li></ul>`,
    examples: JSON.stringify([
      { input: "no input", output: `.spinner { animation: spin 1s linear infinite; } @keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }` },
    ]),
    testCases: JSON.stringify([
