...
const FEATURES = [
  ...
  },
  {
    ...
    accent: "from-stone-400/15 to-transparent",
  },
  {
    ...
    accent: "from-neutral-300/15 to-transparent",
  },
  {
    ...
    accent: "from-zinc-300/15 to-transparent",
  },
  {
  ...
  },
  {
    ...
    accent: "from-stone-300/15 to-transparent",
  },
];
    ...
    <section className="relative py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <Reveal className="text-center mb-16">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-stone-400 mb-3">Why CodeArena</p>
            ...
            <Reveal key={f.title} delay={(i % 3) * 90}>
              <div className="group relative h-full rounded-2xl glass p-6 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.07]">
                ...
                <div className="relative">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-white/10 to-stone-400/15 border border-white/10 flex items-center justify-center text-zinc-200 mb-4">
                    {f.icon}
                  </div>
