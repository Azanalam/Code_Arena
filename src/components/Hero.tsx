    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-zinc-950 to-black text-white px-4">
      <div className="text-center space-y-8 max-w-lg">
        <div className="space-y-2">
          <h1 className="text-5xl sm:text-6xl font-bold tracking-tight bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent">
        ...
        {user ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-3 justify-center">
              <a
                href="/lobby"
                className="px-6 sm:px-8 py-3 bg-blue-600 hover:bg-blue-500 rounded-xl font-medium transition-all"
              >
                Play Now
              </a>
              <button
                onClick={() => signOut()}
                className="px-6 sm:px-8 py-3 bg-zinc-800 hover:bg-zinc-700 rounded-xl font-medium transition-all"
              >
                Sign Out
              </button>
            </div>
          ...
          <div className="space-y-3">
            <a
              href="/lobby"
              className="inline-block px-6 sm:px-8 py-3 bg-blue-600 hover:bg-blue-500 rounded-xl font-medium transition-all"
            >
              Play as Guest
            </a>
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              <button
                ...
                className="flex items-center gap-2 px-4 sm:px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 rounded-xl font-medium transition-all text-sm"
              >
